...
# get the current working directory and concatenate /mens_team
directory = os.path.join(os.getcwd(), 'mens_team')

# initialize an empty list to store html file names
html_files = []
...
nav_content = '<nav><details><summary>Men\'s Roster</summary>\n'

# Generate the links with the correct path and add line breaks
for html_file in html_files:
    nav_content += f'  <a href="{html_file}">{html_file}</a><br>\n'

# Close the nav, details, and summary tags correctly
nav_content += '</details></nav>'

# print the content to the console
print(nav_content)

# optionally, write the content to an html file
with open('nav_links.html', 'w') as f:
    f.write(nav_content)
